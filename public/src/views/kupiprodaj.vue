            ...
            <div class="modal-body">
                <form @submit.prevent="objave()" role="form" method="novaObjava()" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="dodajsliku" @file.prevent="dodajSlikuFunkcija()" name="fileid" multiple>
                        </div>
...
function updateParent() {
    ...
    return false;
        ...
        function dodajSlikuFunkcija()
        {
            let dbs=firebase.database();
            let stg=firebase.storage();
            let inp=document.getElementById("dodajsliku");
            inp.onchange=lasted;
            let fname=this.files[0].name;
            let btns=stg.ref("Objave/" + fname);
            btns.put(fname);
        }
